...
set "DJANGO_SETTINGS_MODULE=opc.settings"
...
start "Uvicorn ASGI Server" cmd /k "cd /d %DJANGO_PROJECT_DIR% && set DJANGO_SETTINGS_MODULE=opc.settings&& python -m uvicorn %ASGI_APP% --port %UVICORN_PORT% --reload"
